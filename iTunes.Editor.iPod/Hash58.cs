...
// 2007-09-16
//
// Unfucking your iPod (in 2 days)
//
// Thanks to everyone on #gtkpod that made this possible (wtbw, nopcode, 
// retar_d, oleavr, desrt and everyone that provided DBs and IDs).
//
// <auto-generated/>
...
namespace IPod
{
    ...
    {    
        ...
        public static byte [] GenerateHash(string fwid, byte [] iTunesDB)
        {
            return GenerateHash(fwid, iTunesDB, SizeOfHeaders);
        }
        ...
        public static byte [] GenerateHash(string fwid, byte [] iTunesDB, int sizeOfHeaders)
        {
            ...
            return GenerateHash(_fwid, iTunesDB, sizeOfHeaders);
        }
